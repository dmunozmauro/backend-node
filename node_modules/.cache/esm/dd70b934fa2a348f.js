let dotenv,path;_fa2‍.w("dotenv",[["default",["dotenv"],function(v){dotenv=v}]]);_fa2‍.w("path",[["default",["path"],function(v){path=v}]]);


_fa2‍.g.console.log('Vamos a revisar el ambiente...', process.env.NODE_ENV)
